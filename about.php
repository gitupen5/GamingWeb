...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <!-- <div class="jumbotron">
  <h1>Viblight Games</h1>
  <p>We Make Video Games</p>
</div> -->


    <section class="my-5">
    <div class="py-5">
        <h3 class="display-4 text-center ">Contact</h3>
    </div>
    <div class="text-center">
    <h3 class="py-3">You can find me on most social media platforms. <br>
                Feel free to Follow me on Instagram or tweet at me! <br>
                Please only use my email for business inquires, <br>
